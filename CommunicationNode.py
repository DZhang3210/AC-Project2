...
class SecurePeer:
    ...
    def encrypt_message(self, message):
        if not self.symmetric_key:
            raise Exception(f"Handshake required before sending messages from {self.identity}")
    ...
    def decrypt_message(self, encrypted_data):
        if not self.symmetric_key:
            raise Exception(f"Handshake required before receiving messages from {self.identity}")
