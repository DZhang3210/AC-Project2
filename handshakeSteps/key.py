...
def key_response(self, data):
    ...
    nonce_with_timestamp = data[:22]  # First 22 bytes (26 nonce + 10 timestamp)
    received_mac = data[-48:]  # Last 48 bytes
    encrypted_message = data[22:-48]  # Everything between nonce_with_timestamp and mac
     # Decrypt the message to get ephemeral key
    ...
    nonce_with_timestamp_from_decrypt = decrypted_data[32:]  # Should match nonce_with_timestamp
    ...
    ack_message = b"ACK" + nonce_with_timestamp
